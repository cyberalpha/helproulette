    ...
    <div className={cn("grid grid-cols-14 gap-1 border-4 border-white rounded-xl p-4 mb-6", 
      ...
      <div className="col-span-12">
        ...
        <div className="grid grid-cols-6 gap-1 mt-1">
          <div 
            className="col-span-1 bg-gradient-to-br from-roulette-green to-green-700 border border-white/60 text-white text-center font-bold cursor-pointer hover:bg-roulette-green/80 flex items-center justify-center h-[48px] rounded-xl shadow-md hover:scale-[1.03] active:scale-[0.97] transition-all animate-pulse-light"
          ...
          <div 
            className="col-span-1 bg-gradient-to-br from-roulette-red to-red-700 border border-white/60 cursor-pointer hover:bg-roulette-red/80 flex items-center justify-center h-[48px] rounded-xl shadow-md hover:scale-[1.03] active:scale-[0.97] transition-all animate-pulse-light"
            onClick={() => onOptionSelect('color', 'rojo')}
          >
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-roulette-red to-red-700"></div>
          </div>
          <div 
            className="col-span-1 bg-gradient-to-br from-roulette-black to-gray-800 border border-white/60 cursor-pointer hover:bg-roulette-black/80 flex items-center justify-center h-[48px] rounded-xl shadow-md hover:scale-[1.03] active:scale-[0.97] transition-all animate-pulse-light"
      ...
      <div className="col-span-1 flex flex-col">
        <div 
          className="bg-gradient-to-br from-roulette-green to-green-700 border border-white/60 text-white flex items-center justify-center font-bold text-xs md:text-sm cursor-pointer hover:bg-roulette-green/80 h-[48px] ml-1 mb-1 rounded-xl shadow-md hover:scale-[1.03] active:scale-[0.97] transition-all animate-pulse-light"
        ...
        <div 
          className="bg-gradient-to-br from-roulette-green to-green-700 border border-white/60 text-white flex items-center justify-center font-bold text-xs md:text-sm cursor-pointer hover:bg-roulette-green/80 h-[48px] ml-1 rounded-xl shadow-md hover:scale-[1.03] active:scale-[0.97] transition-all animate-pulse-light"
